...
| [HELM-T10](./resolved/HELM-T10-gitradar-functional-hardcoded-paths.md) | gitradar | CI red — hardcoded paths | ✅ functional suite rebuilt on self-contained git fixtures (generated in beforeAll) — runs in CI |
