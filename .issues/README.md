...
| [HELM-T10](./resolved/HELM-T10-gitradar-functional-hardcoded-paths.md) | gitradar | CI red — hardcoded paths | ✅ functional suite skips when its hardcoded local repos are absent (follow-up: self-contained fixtures) |
