...
const imageDescribed: SourceType = {
  id: 'image-described',
  description:
    'Images — two-stage: vision LLM describes → text embedder vectorizes. Uses agent-vl Docker service; calls @helmsmith/agent-adapter directly (NOT through harness-core).',
  matcher: {
