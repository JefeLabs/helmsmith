...
phases: 8
prerequisites:
  - Pencil MCP server (for wireframes / pages) and/or @helmsmith/mech-pencil (for system generation)
...
JSON with **`@helmsmith/mech-pencil`** — this **replaces** the kit's former
