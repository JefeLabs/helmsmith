...
import { type LoaderEvent, spawnLoaderJob } from '@helmsmith/harness-server';
 ...
 * its own peer CLI (`@helmsmith/edge-memory-cli`). harness-cli is now
...
function memoryDeprecationNotice(): never {
  console.error(
    [
      ...
      '',
      'Install:',
      '  npm install -g @helmsmith/edge-memory-cli   # or pnpm/yarn equivalent',
      '',
...
function usage(): void {
  console.error(
    [
      ...
      '  edge-memory <query|put|forget|health> ...   # @helmsmith/edge-memory-cli',
