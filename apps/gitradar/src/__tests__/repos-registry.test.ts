...
describe('loadReposRegistry', () => {
  ...
  it('throws on invalid YAML', async () => {
    ...
    await expect(loadReposRegistry('/some/dir/repos.yml')).rejects.toThrow(
      'Invalid YAML in /some/dir/repos.yml',
    );
  });
  ...
  const globalSource: RegistrySource = {
    ...
    registry: {
      workspaces: {
        frontend: {
          label: 'Frontend Apps',
          repos: [{ name: 'web-app', path: '/code/web-app', group: 'web', tags: [] }],
        },
        backend: {
          label: 'Backend Services',
          repos: [{ name: 'api', path: '/code/api', group: 'api', tags: [] }],
        },
      },
      groups: {},
      tags: {},
    ...
    registry: {
      workspaces: {
        frontend: {
          ...
          repos: [{ name: 'project-ui', path: '/projects/foo/ui', group: 'web', tags: [] }],
        },
        devops: {
          repos: [{ name: 'infra', path: '/projects/foo/infra', group: 'ops', tags: [] }],
        },
      },
      groups: {},
      tags: {},
