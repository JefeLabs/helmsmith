...
// Users extend this list via config.settings.ignore_patterns (additive by
// default); set ignore_patterns_replace_defaults: true to start from scratch.

const DEFAULT_IGNORE_PATTERNS: string[] = [
  // Lock files — generic suffixes catch bun/yarn/cargo/flake/mix/pubspec/Podfile/...
  '*.lock',
  '*.lockb',
  // Lock files that don't use the .lock suffix
  'package-lock.json',
  'packages.lock.json',
  'pnpm-lock.yaml',
  'go.sum',
  'Package.resolved',
  'gradle.lockfile',
  // Dependency directories (accidentally tracked or intentionally vendored)
  'node_modules/*',
  'vendor/*',
  'Pods/*',
  '.venv/*',
...
export interface IgnoreMatcherOptions {
  /** When true, `userPatterns` fully replaces the built-in defaults instead of extending them. */
