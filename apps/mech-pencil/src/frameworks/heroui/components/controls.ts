  ...
  return comp(
    frame(
      'toggle-button',
      {
        ...
        cornerRadius: c.rmd,
        fill: c.soft,
        stroke: { thickness: c.bw, fill: c.acc },
      },
...
export function buildLink(ctx: BuildContext): Child {
  ...
  return comp(
    frame(
      'link',
      { name: 'Link', layout: 'horizontal', width: 'fit_content', height: 'fit_content' },
      [
  ...
  return comp(
    frame(
      'kbd',
      {
        ...
        cornerRadius: c.rsm,
        fill: c.surf,
        stroke: { thickness: c.bw, fill: c.bd },
      },
...
export function buildLabelComp(ctx: BuildContext): Child {
  ...
  return comp(
    frame(
      'label',
      { name: 'Label', layout: 'horizontal', width: 'fit_content', height: 'fit_content' },
...
export function buildDescription(ctx: BuildContext): Child {
  ...
  return comp(
    frame(
      'description',
      { name: 'Description', layout: 'horizontal', width: 'fit_content', height: 'fit_content' },
      [
        text('description-text', 'We never share your email.', {
          fill: c.mut,
          fontFamily: c.ff,
          fontSize: c.fs,
        }),
...
export function buildTextArea(ctx: BuildContext): Child {
  ...
  return comp(
    frame(
      ...
      [
        text('text-area-text', 'Write something…', {
          fill: c.fph,
          fontFamily: c.ff,
          fontSize: c.fm,
        }),
...
export function buildTextField(ctx: BuildContext): Child {
  ...
  return comp(
    frame('text-field', { name: 'TextField', width: 300, layout: 'vertical', gap: 6 }, [
      ...
      text('text-field-help', 'We never share your email.', {
        fill: c.mut,
        fontFamily: c.ff,
        fontSize: 12,
      }),
...
export function buildInputGroup(ctx: BuildContext): Child {
  ...
  return comp(
    frame(
      'input-group',
      { name: 'InputGroup', width: 320, height: 40, layout: 'horizontal', alignItems: 'center' },
      [
        frame(
          'input-group-addon',
          {
            ...
            padding: [12, 0],
            fill: c.soft,
            cornerRadius: [c.rmd, 0, 0, c.rmd],
          },
          [
            text('input-group-addon-text', 'https://', {
              fill: c.mut,
              fontFamily: c.ff,
              fontSize: c.fm,
            }),
        ...
        frame(
          'input-group-input',
          {
            ...
            fill: c.fbg,
            stroke: { thickness: c.bw, fill: c.bd },
            cornerRadius: [0, c.rmd, c.rmd, 0],
          },
          [
            text('input-group-input-text', 'your-site', {
              fill: c.fph,
              fontFamily: c.ff,
              fontSize: c.fm,
            }),
  ...
  const cell = (i: number, val: string, active: boolean) =>
    frame(
      `input-otp-${i}`,
      {
        ...
        cornerRadius: c.rmd,
        fill: c.fbg,
        stroke: { thickness: active ? 2 : c.bw, fill: active ? c.acc : c.bd },
      },
      [
        text(`input-otp-${i}-d`, val, {
          fill: c.fg,
          fontFamily: c.ff,
          fontSize: 20,
          fontWeight: '600',
...
function checkRow(
  ...
  return frame(
    `${prefix}-${i}`,
    { name: text2, layout: 'horizontal', width: 'fit_content', alignItems: 'center', gap: 10 },
    [
      frame(
        `${prefix}-${i}-box`,
        {
          ...
          justifyContent: 'center',
          cornerRadius: c.rsm,
          fill: checked ? c.acc : c.surf,
          stroke: checked ? undefined : { thickness: c.bw, fill: c.bd },
        },
        checked
          ? [
              text(`${prefix}-${i}-chk`, '✓', {
...
export function buildCheckboxGroup(ctx: BuildContext): Child {
  return comp(
    frame(
      'checkbox-group',
      { name: 'CheckboxGroup', layout: 'vertical', width: 'fit_content', gap: 12 },
      [
    ...
    [
      frame(
        `${prefix}-${i}-o`,
        {
          ...
          cornerRadius: FULL,
          fill: c.surf,
          stroke: { thickness: 2, fill: sel ? c.acc : c.bd },
        },
        sel
          ? [
              frame(`${prefix}-${i}-dot`, {
...
export function buildRadioGroup(ctx: BuildContext): Child {
  return comp(
    frame(
      'radio-group',
      { name: 'RadioGroup', layout: 'vertical', width: 'fit_content', gap: 12 },
      [
...
export function buildTagGroup(ctx: BuildContext): Child {
  ...
  return comp(
    frame('tag-group', { name: 'TagGroup', layout: 'horizontal', width: 'fit_content', gap: 8 }, [
      tag(0, 'Design'),
      tag(1, 'Eng'),
      tag(2, 'Ops'),
    ]),
  ...
  const seg = (i: number, s: string, active: boolean) =>
    frame(
      `button-group-${i}`,
      {
        ...
        justifyContent: 'center',
        padding: [16, 10],
        fill: active ? c.acc : c.surf,
        stroke: { thickness: c.bw, fill: c.bd },
      },
      [
        text(`button-group-${i}-label`, s, {
          fill: active ? c.accFg : c.fg,
          fontFamily: c.ff,
          fontSize: c.fm,
          fontWeight: '600',
        }),
  ...
  const seg = (i: number, s: string, active: boolean) =>
    frame(
      `toggle-button-group-${i}`,
      {
        ...
        padding: [14, 9],
        cornerRadius: c.rsm,
        fill: active ? c.soft : 'transparent',
      },
      [
        text(`toggle-button-group-${i}-label`, s, {
          fill: active ? c.acc : c.mut,
          fontFamily: c.ff,
          fontSize: c.fs,
          fontWeight: '600',
        }),
