...
export const TYPE_STEPS: TypeStep[] = [
  ...
  {
    name: 'h1',
    sizeKey: 'font.h1.size',
    role: 'display',
    weight: '700',
    lineHeight: 1.22,
    sample: 'Run an agent job',
  },
  {
    name: 'h2',
    sizeKey: 'font.h2.size',
    role: 'display',
    weight: '600',
    lineHeight: 1.27,
    sample: 'Confirm & start',
  },
  {
    name: 'h3',
    sizeKey: 'font.h3.size',
    role: 'display',
    weight: '600',
    lineHeight: 1.33,
  ...
  {
    name: 'body-lg',
    sizeKey: 'font.body-lg.size',
    role: 'body',
    weight: '400',
    lineHeight: 1.5,
    sample: 'The coordinator paraphrases your intent before the job runs.',
  },
  {
    name: 'body-md',
    sizeKey: 'font.body-md.size',
    role: 'body',
    weight: '400',
    lineHeight: 1.43,
    sample: 'Default UI text — dense operator console at 14px.',
  },
  {
    name: 'body-sm',
    sizeKey: 'font.body-sm.size',
    role: 'body',
    weight: '400',
    lineHeight: 1.38,
    sample: 'Secondary metadata and helper text.',
  },
  {
    name: 'caption',
    sizeKey: 'font.caption.size',
    role: 'body',
    weight: '500',
    lineHeight: 1.33,
    sample: 'STORY POINTS · EST. BY FLOW',
  },
  {
    name: 'code-md',
    sizeKey: 'font.code-md.size',
    role: 'mono',
    weight: '450',
    lineHeight: 1.46,
    sample: 'job_a1b2c3d4 · loadContext.ts (+12 -3)',
  },
  {
    name: 'code-sm',
    sizeKey: 'font.code-sm.size',
    role: 'mono',
    weight: '450',
    lineHeight: 1.42,
    sample: 'sha256:9f3a… · 14:02:11 planner routed',
  },
];
...
export const CURATED_SETS: FontSet[] = [
  {
    ...
    body: 'Albert Sans',
    mono: 'JetBrains Mono',
    note: 'Bold geometric display over a clean grotesque body — fontpair.co.',
  },
  {
    id: 'urbanist-opensans',
    display: 'Urbanist',
    body: 'Open Sans',
    mono: 'JetBrains Mono',
    note: 'Geometric display + humanist body — fontpair.co.',
  },
  {
    id: 'worksans-bitter',
    display: 'Work Sans',
    body: 'Bitter',
    mono: 'JetBrains Mono',
    note: 'Grotesk headings + slab-serif body, editorial — fontpair.co.',
  },
  {
    id: 'archivo-inter',
    display: 'Archivo',
    body: 'Inter',
    mono: 'IBM Plex Mono',
    note: 'Condensed-grotesk headings; IBM Plex Mono for code — fontpair.co.',
  },
];
