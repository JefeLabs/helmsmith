...
import com.jefelabs.helmsmith.controlplane.catalog.domain.CatalogItem;
import com.jefelabs.helmsmith.controlplane.catalog.domain.CatalogItemType;
import com.jefelabs.helmsmith.controlplane.catalog.service.CatalogItemService;
...
import com.jefelabs.helmsmith.controlplane.proposals.integration.SkillzkitClient;
import com.jefelabs.helmsmith.controlplane.proposals.persistence.SkillProposalDao;
import com.jefelabs.helmsmith.controlplane.proposals.persistence.SkillProposalDaoRow;
...
public class SkillProposalService {
     ...
     * iteration syncs the draft back to the @helmsmith/skillzkit repo
     * as a real PR.
     */
    @Transactional
        ...
        if ("accepted".equals(fetched.remoteStatus()) || "promoted".equals(fetched.remoteStatus())) {
            ...
            if (proposal != null && proposal.catalogItemId() != null) {
                catalogItemService.softDelete(
                    orgId,
                    com.jefelabs.helmsmith.controlplane.catalog.domain.CatalogItemType.SKILL,
