...
import com.jefelabs.helmsmith.controlplane.core.events.JobIntentProducedEvent;
import com.jefelabs.helmsmith.controlplane.job.domain.Job;
import com.jefelabs.helmsmith.controlplane.job.domain.JobStatus;
import com.jefelabs.helmsmith.controlplane.job.domain.StepStatus;
import com.jefelabs.helmsmith.controlplane.job.persistence.JobDao;
import com.jefelabs.helmsmith.controlplane.job.persistence.JobEventDao;
import com.jefelabs.helmsmith.controlplane.job.persistence.JobStepDao;
...
public class JobEngine {
    ...
    private Job reload(Object daoRow) {
        ...
        var row = (com.jefelabs.helmsmith.controlplane.job.persistence.JobDaoRow) daoRow;
        return new Job(
