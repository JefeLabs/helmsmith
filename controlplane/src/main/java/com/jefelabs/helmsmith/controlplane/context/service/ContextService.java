package com.jefelabs.helmsmith.controlplane.context.service;
...
import com.jefelabs.helmsmith.controlplane.context.integration.AgentxLoadRunner;
...
import com.jefelabs.helmsmith.controlplane.context.persistence.IngestionJobDao;
    ...
    public ContextSource registerSource(ContextSource source) {
        ...
        dao.upsert(
            ...
            source.refreshSchedule() != null ? source.refreshSchedule()
                : com.jefelabs.helmsmith.controlplane.context.domain.RefreshSchedule.MANUAL,
